...
plt.rcParams.update({
    "font.size": 18,         # 基本文字
    "axes.titlesize": 22,    # 標題字體
    "axes.labelsize": 20,    # 座標軸標籤
    "xtick.labelsize": 18,   # x 軸刻度
    "ytick.labelsize": 18,   # y 軸刻度
...
def plot_metric(df, metric, output_path):
    ...
    plt.xlabel("Number of Destinations", labelpad=10)
    ...
    plt.xticks(sorted(df["dest_num"].dropna().unique()))
